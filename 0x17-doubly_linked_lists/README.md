...
Write a function that returns the nth node of a dlistint_t linked list.
    ...
    Prototype: dlistint_t *get_dnodeint_at_index(dlistint_t *head, unsigned int index); where index is the index of the node, starting from 0
...
Write a function that deletes the node at index index of a dlistint_t linked list.
    ...
    Prototype: int delete_dnodeint_at_index(dlistint_t **head, unsigned int index); where index is the index of the node that should be deleted. Index starts at 0
